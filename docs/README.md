...
Start with [implementation status](IMPLEMENTATION_STATUS.md) for what exists and what remains unproved, then [validation](VALIDATION.md) for reproducible evidence.
