...
- The first investment proof excludes US users. 0x RWA access also requires an explicit grant; a standard API key, non-US wallet or self-attestation does not establish an eligible order.
