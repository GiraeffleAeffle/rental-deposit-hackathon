...
Updated 23 September 2026. The SDK integration and development-dashboard configuration exist. A real passkey, linked backup email, user-owned EVM/Solana wallets and same-wallet recovery in a second browser have been observed locally. Physical-device recovery and sponsored transactions remain unproved.
